...
var FFmpeg = class {
  constructor() {
     ...
     */
    __privateAdd(this, _send, ({ type, data }, trans = []) => {
      if (!__privateGet(this, _worker)) {
     ...
     */
    __publicField(this, "load", (config = {}) => {
      if (!__privateGet(this, _worker)) {
        __privateSet(this, _worker, new Worker(new URL("./worker.js", import.meta.url), {
          type: "module"
        }));
     ...
     * @category FFmpeg
     */
    __publicField(this, "exec", (args, timeout = -1) => __privateGet(this, _send).call(this, {
     ...
     * @category File System
     */
    __publicField(this, "readFile", (path, encoding = "binary") => __privateGet(this, _send).call(this, {
     ...
     * @category File System
     */
    __publicField(this, "deleteFile", (path) => __privateGet(this, _send).call(this, {
     ...
     * @category File System
     */
    __publicField(this, "rename", (oldPath, newPath) => __privateGet(this, _send).call(this, {
     ...
     * @category File System
     */
    __publicField(this, "createDir", (path) => __privateGet(this, _send).call(this, {
     ...
     * @category File System
     */
    __publicField(this, "listDir", (path) => __privateGet(this, _send).call(this, {
     ...
     * @category File System
     */
    __publicField(this, "deleteDir", (path) => __privateGet(this, _send).call(this, {
